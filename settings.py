...
MAIN_MANAGER_KEYBOARD = [['Создать новую кампанию'],
                         ['Запустить созданную кампанию', 'Автоматизировать кампанию'],
                         ['Получить статусы кампаний', 'Получить статистику кампании'],
                         ['Добавить наблюдателя', 'Обновить кабинеты']]

MAIN_SPECTATOR_KEYBOARD = [['Получить статусы кампаний', 'Получить статистику кампании']]
